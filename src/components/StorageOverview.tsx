...
export const StorageOverview: React.FC<StorageOverviewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-4 py-3 md:py-4">
          <div className="flex items-center justify-between mb-3 md:mb-4">
            <h1 className="text-xl md:text-2xl font-bold text-gray-800">Minha Cozinha</h1>
            <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 md:p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xl md:text-2xl font-bold text-blue-800">{products.length}</div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-2 md:p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xl md:text-2xl font-bold text-green-800">{expiryStats.safe}</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-2 md:p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xl md:text-2xl font-bold text-yellow-800">{expiryStats.expiring}</div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-2 md:p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xl md:text-2xl font-bold text-red-800">{expiryStats.expired}</div>
      ...
      {/* Storage Locations */}
      <div className="px-4 py-3 md:py-4">
        <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-2 md:mb-3">Locais de Armazenamento</h2>
      ...
      {(selectedLocation || searchQuery || filterOptions.categories.length > 0) && (
        <div className="px-4 py-3 md:py-4 border-t">
          <div className="flex items-center justify-between mb-3 md:mb-4">
          ...
          <div className="relative mb-3 md:mb-4">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
            />
          </div>
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-6 md:py-8">
              ...
              <p className="text-sm md:text-base text-gray-600">Nenhum produto encontrado</p>
            </div>
          ) : viewMode === 'grid' ? (
...
const LocationCard: React.FC<LocationCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="font-semibold text-sm md:text-base text-gray-800 mb-1 truncate">{location.name}</h3>
      <p className="text-xs md:text-sm text-gray-600 mb-2 md:mb-3 truncate">{location.description}</p>
      ...
      {location.temperature && (
        <div className="flex items-center gap-1 text-xs text-gray-600 mt-1 md:mt-2">
      ...
      <button
        ...
        className="w-full mt-2 md:mt-3 py-1 md:py-1 bg-white border border-gray-200 rounded text-xs md:text-sm text-gray-700 hover:bg-gray-50 transition-colors"
      >
        Adicionar aqui
      </button>
    </div>
...
const ProductCard: React.FC<ProductCardProps> = ({ product, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`border rounded-lg p-2 md:p-3 cursor-pointer hover:shadow-md transition-all ${getStatusColor()}`}
    >
      {product.image && (
        <img
          src={product.image}
          alt={product.name}
          className="w-full h-16 md:h-24 object-cover rounded mb-2"
        />
      )}
      
      <h4 className="font-medium text-gray-800 text-xs md:text-sm mb-1 truncate">{product.name}</h4>
      <p className="text-xs text-gray-600 mb-2 truncate">{getProductCategoryName(product)}</p>
...
const ProductListItem: React.FC<ProductCardProps> = ({ product, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white border border-gray-200 rounded-lg p-3 md:p-4 cursor-pointer hover:shadow-md transition-all"
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h4 className="font-medium text-sm md:text-base text-gray-800 truncate">{product.name}</h4>
              <p className="text-xs md:text-sm text-gray-600 truncate">{getProductCategoryName(product)}</p>
              <div className="flex flex-wrap items-center gap-2 md:gap-4 text-xs text-gray-600 mt-1">
